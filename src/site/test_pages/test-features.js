...
console.log(message);
var base_server_url = "https://study-backend.ibaguette.com";
var localhost_server_url = "http://localhost:8787"; // local testing server / in case of cors
...
function update_text(text_to_set) {
    if (main_text_component) {
